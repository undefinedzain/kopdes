...
export default function ConfirmationRegistration({
  ...
  const onFinish = (values) => {
    ...
    axios
      .patch('https://api.merahputih.kop.id/api/cooperative/agreement-confirmation', data, options)
      .then((res) => {
        message.success('Pendaftaran berhasil dikonfirmasi');
        setLoadingForm(false);
        router.push('/masuk');
      })
      .catch(() => {
        message.error('Pendaftaran gagal dikonfirmasi');
        setLoadingForm(false);
      });
  };
  ...
  return (
    <div className="bg-[#f5f5f5] px-4 py-10 text-sm text-[#222] font-sans min-h-screen">
      <div className="max-w-xl mx-auto bg-white p-8 rounded-xl shadow">
        ...
        <p>
          Halo Bapak/Ibu <strong>Kuasa Penghadap Notaris Koperasi</strong>,
        </p>
        <p className="mt-4">
        ...
        <div className="grid grid-cols-2 gap-y-2 gap-x-6">
          ...
          <div className="col-span-2 border-t pt-4 mt-2">
            <p className="text-gray-600">Kuasa Penghadap Notarisb</p>
        ...
        <p className="mt-4 font-bold">
          Dengan menekan tombol di bawah ini, Anda menyatakan telah membaca,
          memahami, dan menyetujui serta siap bertanggung jawab atas seluruh
          pernyataan di atas.
        </p>
