...
export default function CooperativelegalStages() {
  ...
  const fetchCooperativeData = () => {
    ...
    axios
      .get(`https://api.merahputih.kop.id/api/cooperative/legal-stages/by-cooperative-id/${checkCooperative?.cooperativeId}`, options)
      .then((res) => {
